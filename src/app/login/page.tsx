      ...
      <div className="mb-8 flex flex-col items-center space-y-4 text-center">
        ...
        <div className="space-y-2">
          <h1 className="text-[24px] font-normal tracking-tight text-[#fafafa]">
            {isSignUp ? 'Create your account' : 'Welcome to Sentinel'}
          </h1>
          <p className="text-[14px] text-[#b4b4b4]">
            {isSignUp ? 'Register to start scanning targets' : 'Sign in to access your operator portal'}
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 text-center text-[14px] text-[#898989]">
        {isSignUp ? (
          <>
            ...
            <button type="button" onClick={() => { setError(null); setIsSignUp(false); }} className="text-[#fafafa] hover:text-[#3ecf8e] transition-colors">
              Sign In
            </button>
          </>
        ) : (
          <>
            ...
            <button type="button" onClick={() => { setError(null); setIsSignUp(true); }} className="text-[#fafafa] hover:text-[#3ecf8e] transition-colors">
              Sign Up
            </button>
          </>
        )}
